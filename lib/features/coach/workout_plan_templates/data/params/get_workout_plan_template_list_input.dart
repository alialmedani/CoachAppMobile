...
/// Query for the coach workout-plan-template list
/// (`GetWorkoutPlanTemplateListInput`, a `PagedAndSortedResultRequestDto`).
///
...
class GetWorkoutPlanTemplateListInput extends BaseParams {
  GetListRequest? request;
  String? filter;
  String? sorting;

  GetWorkoutPlanTemplateListInput({this.request, this.filter, this.sorting});
