...
Future<bool?> showSaveNutritionPlanAsTemplateSheet(
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (_) => BlocProvider(
      create: (_) => getIt<NutritionPlanTemplateCubit>(),
      child: _SaveNutritionPlanAsTemplateSheet(
        planId: planId,
        planName: planName,
      ),
    ),
...
class _SaveNutritionPlanAsTemplateSheet extends StatefulWidget {
  final String planId;
  final String planName;

  const _SaveNutritionPlanAsTemplateSheet({
    required this.planId,
    required this.planName,
  });

  @override
  State<_SaveNutritionPlanAsTemplateSheet> createState() =>
      _SaveNutritionPlanAsTemplateSheetState();
}

class _SaveNutritionPlanAsTemplateSheetState
    extends State<_SaveNutritionPlanAsTemplateSheet> {
  ...
  Future<void> _save() async {
    ...
    final result = await context
        .read<NutritionPlanTemplateCubit>()
        .saveAsTemplate(
          widget.planId,
          _name.text.trim(),
