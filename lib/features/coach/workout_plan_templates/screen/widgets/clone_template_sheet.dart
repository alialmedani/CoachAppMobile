...
/// Clones a workout template onto a coach-picked trainee.
///
/// Opens the shared trainee picker, asks for confirmation, then calls
/// [WorkoutPlanTemplateCubit.cloneToTrainee]. The new plan inherits the
...
Future<bool> showCloneTemplateSheet(
  BuildContext context, {
  required WorkoutPlanTemplateCubit cubit,
