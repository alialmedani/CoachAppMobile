...
// import 'package:noon_express/core/services/realtime/realtime_service.dart';
// import 'package:noon_express/core/services/notification_router.dart';
// import 'package:noon_express/firebase_options.dart';
...
//   /// Deep-link a notification tap to the right screen for the recipient's
//   /// portal (driver → orders list, merchant → order detail), falling back to the
//   /// splash/home flow when there's nothing actionable in the payload.
//   void _openOrderFromData(Map<String, dynamic> data) {
//     NotificationRouter.open(
//       orderId: (data['orderId'] ?? data['OrderId'])?.toString(),
//       deepLink: (data['deepLink'] ?? data['DeepLink'])?.toString(),
//     );
//   }
// }
