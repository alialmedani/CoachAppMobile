...
// NOTE: `matchesFilter(OrderModel, OrderListFilter)` was removed here — it was a
// delivery-order status helper coupled to the (unported) order feature model.
// Rebuild it against the real CoachApp model when/if the order filter is needed.
